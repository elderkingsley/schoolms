...
.modal { background:var(--c-surface); border-radius:var(--r-md); width:100%; max-width:440px; padding:24px; box-shadow:0 20px 60px rgba(0,0,0,0.15); }
...
<div class="pg-header">
    <div>
        ...
        <div class="pg-sub">Manage academic sessions and activate terms</div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex;gap:5px;flex-wrap:wrap;">
                                        ...
                                        @if(! $term->is_active)
                                            <button class="btn-sm btn-sm-danger"
                                                wire:click="confirmDeleteTerm({{ $term->id }})">
                                                Delete
                                            </button>
                                        @endif
                                    </div>
    ...
    <div class="modal-bg" wire:click.self="$set('showSessionForm', false)">
        <div class="modal">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" wire:model="sessionName"
                    placeholder="e.g. 2025/2026" autofocus>
    ...
    <div class="modal-bg" wire:click.self="$set('showTermForm', false)">
        <div class="modal">
            ...
            <div class="form-group">
                ...
                <select class="form-input form-select" wire:model="termName"
                    {{ $editingTermId ? 'disabled' : '' }}>
    ...
    <div class="modal-bg">
        <div class="modal">
            ...
            <p style="font-size:13px;color:var(--c-text-2);margin-bottom:4px;">
                This will permanently delete the session and all its terms.
            </p>
...
@if($confirmingDeleteTermId)
    <div class="modal-bg">
        <div class="modal">
            ...
            <p style="font-size:13px;color:var(--c-text-2);margin-bottom:4px;">
                This will permanently delete this term.
            </p>
